      ...
      <div className="max-w-6xl mx-auto px-8 py-12 relative">
        ...
        <div className="space-y-10">
          ...
          <div>
            ...
            {!isEditing && (
              <div className="mt-6 flex flex-wrap items-center gap-3 justify-between border border-slate-200 dark:border-white/10 rounded-lg px-4 py-3 bg-white dark:bg-black shadow-none">
